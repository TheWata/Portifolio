export const skillsData = [
    ...
    { id: 'arch', label: 'Arquitetura', x: 75, y: 35, status: 'mastered', parent: 'dev_root', icon: 'component', desc: 'Padrões de projeto: MVC e MVVM.' },
    ...
    { id: 'maui', label: 'MAUI', x: 55, y: 70, status: 'developing', parents: ['mobile', 'csharp'], icon: 'layers', desc: 'Apps nativos com .NET e XAML.' },
    { id: 'flutter', label: 'Flutter', x: 70, y: 70, status: 'developing', parent: 'mobile', icon: 'zap', desc: 'UI moderna com Dart.' },
    ...
    { id: 'godot', label: 'Godot', x: 30, y: 85, status: 'developing', parent: 'game_root', icon: 'cpu', desc: 'Explorando GDScript e Nodes.' },
    ...
    { id: 'csharp', label: 'C#', x: 60, y: 90, status: 'mastered', parents: ['backend', 'unity'], icon: 'terminal', desc: 'Linguagem base para .NET e Unity.' }
];